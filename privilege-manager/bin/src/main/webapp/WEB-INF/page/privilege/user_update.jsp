        ...
        <div style="margin:20px auto;">
            <table class="form-tb">
                ...
                <tr>
                    ...
                    <td colspan="3">  
                    	<select name="systemIds" style="width:240px;" class="ipt easyui-combotree" data-options="url:'${basePath}/managment/privilege/user/getUserSystemIds.do?sessionId=${sessionId}&userId=${userId }',required:true,loadFilter:pagerFilterSys,readonly:true,multiple:true,panelHeight:120"></select>
                    </td>
                </tr>
            </table>
        </div>      
