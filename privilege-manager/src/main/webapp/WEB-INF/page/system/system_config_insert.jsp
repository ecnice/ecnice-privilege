        ...
        <div style="margin:20px auto;">
            <table class="form-tb">
                ...
                <tr>
                    ...
                    <td>    
                        <input name="configKey" type="text" class="ipt easyui-validatebox" data-options="required:true,missingMessage:'请输入配置key',validType:'uniquekey'" />
                    </td>
                </tr>
                <tr>
                    <th><em class="cred">*</em>配置key的value值：</th>
                    <td>    
                        <input name="configValue" type="text" class="ipt easyui-validatebox" data-options="required:true,missingMessage:'请输入配置key的value值'" />
                    </td>
                </tr>
                <tr>	
